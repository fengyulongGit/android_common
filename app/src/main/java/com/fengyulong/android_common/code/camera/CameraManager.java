...
package com.fengyulong.android_common.code.camera;
...
public final class CameraManager {
    ...
    public synchronized void setManualFramingRect(int width, int height) {
        ...
        if (initialized) {
            ...
            //将宽、高转为px
            int tempWidth = DisplayUtil.dip2px(width, scale);
            int temPHeight = DisplayUtil.dip2px(height, scale);

            int leftOffset = (screenResolution.x - tempWidth) / 2;
//			int topOffset = (screenResolution.y - height) / 2;
            int topOffset = leftOffset;

            framingRect = new Rect(leftOffset, topOffset, leftOffset + tempWidth,
