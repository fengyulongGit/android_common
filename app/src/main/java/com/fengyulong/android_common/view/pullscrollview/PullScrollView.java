package com.fengyulong.android_common.view.pullscrollview;
...
public class PullScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (GetSystemInfoUtils.getAndroidSDKVersion() > 9) {
    ...
    private void rollBackAnimation() {
        ...
        // 回调监听器
        if (mCurrentTop > (mInitTop + TURN_DISTANCE) / 2 && mOnTurnListener != null) {
