 ...
 */
public class ColoredRatingBarBySmall extends View {
    ...
    public ColoredRatingBarBySmall(Context context) {
        this(context, null);
    }

    public ColoredRatingBarBySmall(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.coloredRatingBarStyle);
    }

    public ColoredRatingBarBySmall(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        if (mType == SMALL) {
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_red_small), BitmapFactory.decodeResource(res, R.drawable.star_orange_small), BitmapFactory.decodeResource(res, R.drawable.star_yellow_super_small)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_white_super_small);
        } else {
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_red), BitmapFactory.decodeResource(res, R.drawable.star_orange), BitmapFactory.decodeResource(res, R.drawable.star_yellow_middle)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_white_midlle);
        }
    }
...
//        }
    ...
    /**
     * 官方的resolveSizeAndState只支持Android 3.0以上，故自定义了一个
     *
     * @param size
     * @param measureSpec
    ...
    public interface OnRatingBarChangeListener {
         ...
         */
        void onRatingChanged(ColoredRatingBarBySmall ratingBar, float rating, boolean fromUser);
